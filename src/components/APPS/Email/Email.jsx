  ...
  return (
    <div className="w-9/12 xl:w-8/12 xl:mx-auto mt-32 mb-20">
      <div className="flex flex-col gap-10 ">
        ...
        <div className="border rounded-md flex flex-wrap md:flex-nowrap	md:flex md:h-[800px] w-full">
          <div className="w-5/12 md:w-3/12">
            <EmailMenu emailLinks={emailLinks}/>
          </div>
          <div className=" w-7/12 md:w-5/12 border border-y-0 h-full">
            <EmailPerson emailPeople={emailPeople}/>
          </div>
          <div className="w-full border md:border-none md:w-7/12">
            <EmailMeassageBox />
          </div>
        </div>
      </div>
